        ...
        public List<ChiTietPhieu> SelectBySql(string sql, List<object> args, CommandType cmdType = CommandType.Text)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    entity.MaChiTiet = reader.GetString(reader.GetOrdinal("MaChiTiet"));
                    entity.MaPhieu = reader.GetString(reader.GetOrdinal("MaPhieu"));
                    entity.MaSanPham = reader.GetString(reader.GetOrdinal("MaSanPham"));
                    entity.TenSanPham = reader.GetString(reader.GetOrdinal("TenSanPham"));
                    entity.SoLuong = reader.GetInt32(reader.GetOrdinal("SoLuong"));
